                        ...
                        <div class="row mb-3">
                           ...
                           <div class="col-md-3">
                              ...
                              <div class="form-group">
                                 <div class="">
                                    <input type="checkbox" class="" id="" name="chk[0][1]" value="1" <?php echo ($val['year_1']?'checked':''); ?>> 1 
                                    <input type="checkbox" class="" id="" name="chk[0][2]" value="1" <?php echo ($val['year_2']?'checked':''); ?>> 2
                                    <input type="checkbox" class="" id="" name="chk[0][3]" value="1" <?php echo ($val['year_3']?'checked':''); ?>> 3
                                    <input type="checkbox" class="" id="" name="chk[0][4]" value="1" <?php echo ($val['year_4']?'checked':''); ?>> 4
                                    <input type="checkbox" class="" id="" name="chk[0][5]" value="1" <?php echo ($val['year_5']?'checked':''); ?>> 5
                                 </div>
                              </div>
                           </div>
                        </div>
...
<script>
   ...
   $(document).ready(function() {
      ...
      $('#btn-plus').click(function(event) {
         ...
         '<a href="#" class="btn btn-danger btn-delete"><i class="las la-trash-alt"></i></a>'+
         '</div>'+
         '</div>';
